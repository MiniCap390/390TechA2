...
public class WeatherStationActivity extends Activity {
	...
	*/
	...
	private double calculateHumidex(){
		...
		243.04 * (log(mLastHumidity / 100) + ((17.625 * mLastTemperature) / (243.04 + mLastTemperature)))
		/ (17.625 -log(mLastHumidity / 100) - ((17.625 * mLastTemperature) / (243.04 + mLastTemperature)));
